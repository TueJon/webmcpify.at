...
REPLACEMENTS = [
    ...
    ('<meta name="description" content="webmcpify is an agent skill that wires your existing web app into WebMCP: inventory, approval, integration, real-browser verification. Open source, MIT.">',
     '<meta name="description" content="webmcpify ist ein Agent-Skill, der deine bestehende Web-App mit WebMCP verbindet: Inventar, Freigabe, Integration, Verifikation im echten Browser. Open Source, MIT.">'),
    ...
    ('<meta property="og:description" content="webmcpify is an agent skill that wires your existing web app into WebMCP: inventory, approval, integration, real-browser verification. Open source, MIT.">',
     '<meta property="og:description" content="webmcpify ist ein Agent-Skill, der deine bestehende Web-App mit WebMCP verbindet: Inventar, Freigabe, Integration, Verifikation im echten Browser. Open Source, MIT.">'),
    ...
    ('<meta name="twitter:description" content="webmcpify is an agent skill that wires your existing web app into WebMCP: inventory, approval, integration, real-browser verification. Open source, MIT.">',
     '<meta name="twitter:description" content="webmcpify ist ein Agent-Skill, der deine bestehende Web-App mit WebMCP verbindet: Inventar, Freigabe, Integration, Verifikation im echten Browser. Open Source, MIT.">'),
